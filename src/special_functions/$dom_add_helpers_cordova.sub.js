            ...
            switch(key){
                ...
                case "dataset":
                    ...
                    for(let k=0, k_key, k_keys= Object.keys(attr), k_length= k_keys.length; k<k_length; k++){
                        k_key= k_keys[k];
                        if(k_key==="jsif_var"&&attrs_A[key].cmd!=="condition-changeval") attrs_A[key].jsif_eq= attr.jsif_val.indexOf(__internal_switch_values_holder.get(active_page+attr.jsif_var)) !== -1;
                        attrs_A[key][k_key]= attr[k_key];
                    }
                    break;
                default:
                    attrs_A[key]= attr;
