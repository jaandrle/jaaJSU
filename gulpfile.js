...
const config= (function(){
        ...
        const gulp= require('gulp'),
              ...
              {fullName, version, build, src_folder, bin_folder, standalone, namespaces_rename, sequence, dependencies, homepage}= JSON.parse($o_default.fs.readFileSync('./package.json')),
              {$g,$o}= mapDependencies(dependencies, $o_default);
        const app= {name: fullName, version, build, src_folder, bin_folder, standalone, namespaces_rename, sequence, homepage};
